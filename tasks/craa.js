...
const scriptsFileName = cp
  .execSync(`npm pack`, { cwd: path.join(packagesDir, 'rest-api-scripts') })
  .toString()
  .trim();
const scriptsPath = path.join(packagesDir, 'rest-api-scripts', scriptsFileName);
...
const craScriptPath = path.join(packagesDir, 'create-rest-api-app', 'index.js');
cp.execSync(
